...
public class Login extends JDialog {
    ...
    /*public void authenicating(String username, String password) throws FileNotFoundException {
        ...
        if(Authenticated){
            ...
            else if(TypeInput.equals("MyFitness.Statistics.User")){
                user = new MyFitness.Statistics.User(username, password);
            }
    ...
    /*public void authenicating(String username, String password) throws FileNotFoundException {
        MyFitness.Statistics.User user1 = db.findByUsername(username);
